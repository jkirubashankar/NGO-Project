<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VolunteerGalary.aspx.cs" Inherits="NGOProject.VolunteerGalary" %>
            ...
            <div style="height: 50px">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <marquee>
                                <h1>AMIT SINGHRAJ WELFARE AND CHARITABLE TRUST</h1></td>
                    </tr>
                </table>
            </div>
            <!-- ******************** Nav Starts Here ******************* -->
                                ...
                                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                      ...
                                      <li class="nav-item active">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link" href="TypeofUserForm.aspx">Members </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="DonorForm.aspx">Donors</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="FundraiserForm.aspx">Fundraiser</a>
                                        </li>
                                        <li class="nav-item">
