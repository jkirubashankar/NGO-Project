<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FundraiserForm.aspx.cs" Inherits="NGOProject.FundraiserForm" %>
...
<div style="height: 800px;margin-top:-200px">
        ...
        <div style="height: 800px">
            <div class="item" style="height: 800px">
                <div class="slider-img" style="height: 800px">
                    <img src="assets/images/NGO_Desktop.jpg" style="height: 800px" />
                </div>
    ...
    <div>
        ...
        <table>
            <tr>
                <td colspan="2" style="text-align: center">Fundraised Details
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblFundraiserName" Text="Fundraiser Name" runat="server"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="TxtFundraiserName" runat="server"></asp:TextBox>
                </td>
            </tr>

            <tr>
                <td>
                    <asp:Label ID="Label1" Text="Fundraised Date" runat="server"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="TxtFundraiseddate" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="DonatedAmount" Text="Fundraised Amount" runat="server"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="TxtFundraisedAmount" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
